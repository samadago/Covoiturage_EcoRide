...
CREATE TABLE participe (
    ...
    utilisateur_id Int NOT NULL,
    CONSTRAINT participe_PK PRIMARY KEY (covoiturage_id, utilisateur_id),
    CONSTRAINT participe_covoiturage_FK FOREIGN KEY (covoiturage_id) REFERENCES covoiturage (covoiturage_id),
